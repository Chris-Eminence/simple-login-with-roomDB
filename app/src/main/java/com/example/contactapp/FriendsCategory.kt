...
class FriendsCategory : AppCompatActivity() {
    private lateinit var binding : ActivityFriendsCategoryBinding
    private val adapter = FriendsCategoryAdapter()


    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityFriendsCategoryBinding.inflate(layoutInflater)
        setContentView(binding.root)
        setUpData(binding)
    }

    private fun setUpData(binding: ActivityFriendsCategoryBinding){
