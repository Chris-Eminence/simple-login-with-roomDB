...
import com.example.contactapp.databinding.ActivityWorkCategoryBinding

class WorkCategory : AppCompatActivity() {
    private lateinit var binding : ActivityWorkCategoryBinding
    private val adapter = FriendsCategoryAdapter()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityWorkCategoryBinding.inflate(layoutInflater)
        setContentView(binding.root)
        setUpData(binding)
    }

    private fun setUpData(binding: ActivityWorkCategoryBinding){
