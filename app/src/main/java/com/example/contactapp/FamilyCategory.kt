...
import com.example.contactapp.Adapters.FamilyCategoryAdapter
import com.example.contactapp.databinding.ActivityFamilyCategoryBinding

class FamilyCategory : AppCompatActivity() {
    private lateinit var binding : ActivityFamilyCategoryBinding
    private val adapter = FamilyCategoryAdapter()
